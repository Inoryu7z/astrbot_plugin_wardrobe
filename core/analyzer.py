...
{{
  ...
  "ref_strength_reason": "用2-3句话具体描述人物的姿势状态与构图设计，说明评级依据。必须包含：①身体的具体姿态（如'斜躺于沙发，一只手搭在头后，腿部舒展交叉'）；②身体曲线/张力的具体表现（如'肩颈、腰臀、腿部曲线展示充分'）；③构图的设计意图或缺失（如'构图有设计感'或'身体无倾斜、无曲线变化'）。不要使用模板化评价（如'视觉表现力较强''仅看轮廓也具有参考模仿价值'），要用具体描述代替抽象评价（仅人物分类需要，衣服分类填空字符串）"
}}
```
...
11. ref_strength 评估标准（严格！此字段仅评估姿势与构图的参考价值，与服装美观程度完全无关。注意分布：大约30%的图应为full，40%为style，30%为reimagine，不要过度偏向style）：
   - "full"：姿势或构图具有强烈的视觉表现力或身体魅力展示——身体线条有张力或曲线感、肢体动作有情绪表达、画面构图有刻意设计、或通过姿态角度刻意展示身体魅力。判断标准：如果只看人物轮廓剪影，这个姿势仍然有看点和模仿价值。只要姿势有设计感、身体有曲线展示、或肢体有张力，就应评为full
   - "style"：姿势有一定韵味或自然的美感，但未达到刻意设计的程度——身体有微妙的角度或姿态感，不是最平淡的站坐。可能带有轻微的身体魅力呈现，但不突出。判断标准：姿势不无聊，但也不足以作为直接模仿对象，取其氛围和感觉即可
   - "reimagine"：姿势构图缺乏表现力，也没有刻意的身体魅力展示，纯粹是展示服装的功能性姿态——身体无倾斜无曲线，构图无设计意图。判断标准：如果只看人物轮廓剪影，这就是一个"人形衣架"，姿势本身没有值得保留的视觉叙事或身体魅力。对镜自拍、正面端正站坐等最平淡的姿态应评为reimagine
