...
11. ref_strength 评估标准（严格！此字段仅评估姿势与构图的参考价值，与服装美观程度完全无关，剪影判断时排除服装轮廓。目标分布：full约30%，style约40%，reimagine约30%。每张图根据实际内容独立判断）：
   评估时从以下维度思考（不需要按维度输出，只需综合判断）：
   - 轮廓辨识度：仅看人物剪影，能否一眼识别姿势的独特性？
   - 肢体设计感：姿势是日常无意识的，还是专门为拍照设计的？肢体是否有舒展/收缩的张力？
   - 身体线条呈现：姿势是否刻意且自然地展示了人体线条（肩颈/腰臀/腿部等）？注意与服装暴露程度无关，只看姿势带来的线条变化
   - 功能性判定：姿势的唯一作用是否只是展示服装？身体是否完全端正无变化？

   综合以上维度，给出评级：
   - "full"：轮廓剪影有独特性和记忆点，姿势有设计感和张力，身体线条展示充分，或通过姿态角度刻意展示身体魅力。判断标准：如果只看人物轮廓剪影，这个姿势仍然有看点和模仿价值
   - "style"：姿势有一定韵味，身体有微妙的角度变化，能传递氛围感，但不具备独立模板价值。判断标准：姿势不无聊，但也不足以作为直接模仿对象，取其氛围和感觉即可
   - "reimagine"：姿势无任何审美价值，身体无倾斜无曲线，构图无设计意图，纯粹是展示服装的功能性姿态。判断标准：如果只看人物轮廓剪影，这就是一个"人形衣架"，姿势本身没有值得保留的视觉叙事或身体魅力。背对镜头展示服装、正面端正站坐仅展示服装等均属此类
