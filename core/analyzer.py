...
11. ref_strength 评估标准（严格！此字段仅评估姿势与构图的参考价值，与服装美观程度完全无关。目标分布：full约30%，style约40%，reimagine约30%。每张图根据实际内容独立判断）：
   ...
   - "reimagine"：姿势无任何审美价值，身体无倾斜无曲线，构图无设计意图，纯粹是展示服装的功能性姿态。判断标准：如果只看人物轮廓剪影，这就是一个"人形衣架"，姿势本身没有值得保留的视觉叙事或身体魅力
