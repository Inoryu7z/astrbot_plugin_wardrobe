...
11. ref_strength 评估标准（仅评估姿势与构图的参考价值，与服装美观无关，剪影判断时排除服装轮廓。目标分布：full约30%，style约40%，reimagine约30%）：
   - "full"：姿势有设计感和张力，身体线条展示充分，或刻意展示身体魅力。剪影仍有模仿价值
   - "style"：姿势有韵味和微妙角度变化，但不具备独立模板价值，取其氛围即可
   - "reimagine"：身体无倾斜无曲线，纯粹展示服装的功能性姿态。背对镜头展示服装、正面端正站坐等均属此类
