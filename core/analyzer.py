...
{{
  ...
  "exposure_features": ["具有视觉吸引力的身体部位暴露，仅限非常规暴露（非日常穿着会露的部位）。如：乳沟、侧乳露出、露背、露肩、腰部裸露、大腿根部露出、臀部部分可见/臀线露出、短裙走光、下装消失（仅内衣/丁字裤）、透视可见内衣、内衣肩带滑落、吊带滑落等。不要记录手臂、小腿、常规肩膀露出等日常暴露部位"],
...
4. exposure_features 判断标准：只记录具有视觉吸引力的非常规暴露部位。日常穿着会露出的手臂、小腿、常规肩膀不要记录。重点关注：乳沟、侧乳露出、露背、露肩、腰部、大腿根部、臀部/臀线、内衣可见、肩带滑落等
